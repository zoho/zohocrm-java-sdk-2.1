...
public class Territory
{
			...
			if(response.isExpected())
			{
				...
				if(responseHandler instanceof ResponseWrapper)
				{
					...
					for(com.zoho.crm.api.territories.Territory territory : territoryList)
					{
						...
						com.zoho.crm.api.territories.Territory reportingTo = territory.getReportingTo();
					...
					com.zoho.crm.api.record.Info info = responseWrapper.getInfo();
	...
	private static void printCriteria(Criteria criteria)
    {
		...
		if(field != null)
		{
			...
			System.out.println("Territory Criteria Field API Name: " + field.getAPIName());
			
			//Get the Field of the Criteria
			System.out.println("Territory Criteria Field Id: " + field.getId());
		}
