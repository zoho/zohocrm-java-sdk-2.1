...
public class Tax
{
	...
	public static void updateTaxes() throws Exception
	{
		...
		tax1.setId(347706112048006l);
		
		tax1.setName("MyTax11343");
	...
	{
		//example
		//ArrayList<Long> taxIds = new ArrayList<Long>(Arrays.asList(34770616198032l,34770615682038l));
