...
public class File
{
	...
	public static void uploadFiles() throws Exception
	{
		...
		StreamWrapper streamWrapper = new StreamWrapper("/Users/test/gitignore_global");

		//Get instance of StreamWrapper class that takes absolute path of the file to be attached as parameter
		StreamWrapper streamWrapper1 = new StreamWrapper("/Users/test/gitignore_global");

		//Get instance of StreamWrapper class that takes absolute path of the file to be attached as parameter
		StreamWrapper streamWrapper2 = new StreamWrapper("/Users/test/gitignore_global");
