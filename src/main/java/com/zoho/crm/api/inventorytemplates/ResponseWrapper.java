...
public class ResponseWrapper implements Model, ResponseHandler
{
	 ...
	 * @return An instance of List<InventoryTemplate>
	 */
	public List<InventoryTemplate> getInventoryTemplates()
	{
	 ...
	 * @param inventoryTemplates An instance of List<InventoryTemplate>
	 */
	public void setInventoryTemplates(List<InventoryTemplate> inventoryTemplates)
	{
